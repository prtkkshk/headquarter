...
const HeroSection = () => {
  ...
  return (
    <section ref={heroRef} className="pt-32 pb-20 md:pt-40 md:pb-28 relative overflow-hidden">
      ...
      {/* Parallax elements */}
      <div className="parallax absolute top-20 left-[10%] w-72 h-72 rounded-full bg-gradient-radial from-socl-primary/10 to-transparent blur-xl" data-speed="0.03"></div>
      <div className="parallax absolute bottom-40 right-[5%] w-96 h-96 rounded-full bg-gradient-radial from-socl-secondary/10 to-transparent blur-xl" data-speed="0.05"></div>
      <div className="parallax absolute top-[40%] right-[20%] w-32 h-32 rounded-full border border-socl-accent/20 opacity-50" data-speed="0.08"></div>
      <div className="parallax absolute left-[20%] bottom-[30%] w-48 h-48 rounded-full border border-socl-primary/20 opacity-50" data-speed="0.06"></div>
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center justify-center bg-socl-cardBg/50 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border border-socl-border animate-fade-in">
            <Sparkles size={20} className="mr-2 text-socl-primary animate-pulse" />
            <span className="font-medium bg-gradient-to-r from-socl-primary to-socl-accent bg-clip-text text-transparent">For Serious Builders Only</span>
          </div>
            ...
            <div className="glass-card border border-socl-border/40 p-4 rounded-2xl shadow-lg max-w-xl mx-auto backdrop-blur-lg relative z-10 animate-float-slow">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center">
                  ...
                  <div className="ml-2">
                    <div className="text-white font-semibold">Structured Feedback</div>
                    <div className="text-xs text-socl-muted">from verified builders</div>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                <div className="glass-card bg-socl-cardBg/30 p-3 rounded-lg">
                  <div className="text-sm font-medium text-socl-primary">Product Value</div>
                  <div className="text-sm text-socl-muted">Clear solution to a real problem. Consider narrowing target audience.</div>
                </div>
                <div className="glass-card bg-socl-cardBg/30 p-3 rounded-lg">
                  <div className="text-sm font-medium text-socl-secondary">UI/UX</div>
                  <div className="text-sm text-socl-muted">Intuitive flow, but onboarding needs simplification.</div>
                </div>
              </div>
            </div>
